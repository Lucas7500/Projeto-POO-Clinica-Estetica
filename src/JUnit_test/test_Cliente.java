...
class test_Cliente {
	...
	static void inicializa() {
		...
		c2 = new Cliente("Lucas Moura", "66666666666", "62911111111",'N');
		c3 = new Cliente("Paulo Freire", "77777777777", "62933333333",'M');
	...
	void test4() {
		c1.addPacote(pacote1);
		c1.addSessaoPacote(s1);
		c1.addSessaoPacote(s2);
		c1.addSessaoPacote(s3);
		c1.addSessaoPacote(s4);
